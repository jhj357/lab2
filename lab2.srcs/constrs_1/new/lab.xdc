set_property PACKAGE_PIN T16 [get_ports {gpio_rtl_0_tri_i[3]}]
set_property PACKAGE_PIN W13 [get_ports {gpio_rtl_0_tri_i[2]}]
set_property PACKAGE_PIN P15 [get_ports {gpio_rtl_0_tri_i[1]}]
set_property PACKAGE_PIN G15 [get_ports {gpio_rtl_0_tri_i[0]}]
set_property PACKAGE_PIN Y16 [get_ports {gpio_rtl_tri_i[3]}]
set_property PACKAGE_PIN V16 [get_ports {gpio_rtl_tri_i[2]}]
set_property PACKAGE_PIN P16 [get_ports {gpio_rtl_tri_i[1]}]
set_property PACKAGE_PIN R18 [get_ports {gpio_rtl_tri_i[0]}]
