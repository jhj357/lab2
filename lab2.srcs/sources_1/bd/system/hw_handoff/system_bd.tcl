...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set btns_4bit [ create_bd_port -dir I btns_4bit ]
  set sw_bit [ create_bd_port -dir I sw_bit ]
  ...
  # Create instance: sw_bit, and set properties
  set sw_bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 sw_bit ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {4}  ] $sw_bit
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins sw_bit/S_AXI]
